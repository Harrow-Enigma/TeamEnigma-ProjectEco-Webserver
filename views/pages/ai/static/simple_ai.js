const FEAT_LAB_PATH = "./ai_static/simple_feat_lab_data.json";
const MODEL_PATH = "./ai_static/simple_tfjs_model/model.json";

const FEAT_PARENT_ID = 'simple_feature_control';
const LAB_PARENT_ID = 'simple_label_vis';
